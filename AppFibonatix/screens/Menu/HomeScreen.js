        ...
        <View style={styles.scrollArea}>
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.Card}>
                    ...
                    <View style={styles.textButtonContainer}>
                        ...
                        <Pressable 
                            ...
                            onPress={() => navigation.navigate('TortugaMatematica')} // Aquí quiero llamarlo de otra forma
                ...
                <View style={styles.Card}>
                    ...
                    <View style={styles.textButtonContainer}>
                        ...
                        <Pressable 
                            ...
                            onPress={() => navigation.navigate('MultipliTortuga')} // Aquí quiero llamarlo de otra forma
                ...
                <View style={styles.Card}>
                    ...
                    <View style={styles.containerImage}>
                        <Image
                            source={{ uri: 'https://your-image-url.com' }} // Inserta la URL de tu imagen
                            style={styles.image}
                        />
                    </View>
